...
SCALE_FACTOR = 1 ######################################
IMAGE_SIZE = int(SCALE_FACTOR * 4096)
BATCH_SIZE = 44 ######################################
FEATURE = '' ######################################
MEMORY = 4 ######################################
...
WARMUP_EPOCHS = 2
NUM_WORKERS = 4
TRAIN_ROOT_DIR = f'/home/akashnyun/pandas_dataset/training_images_4096'
...
RUN_NAME_WANDB = "Baseline_PreTrained_PANDA_ImgSize4096_lr_1e-4_WD"
