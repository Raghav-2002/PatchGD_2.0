...
SCALE_FACTOR = 1 ######################################
IMAGE_SIZE = int(SCALE_FACTOR * 2048)
BATCH_SIZE = 1 ######################################
FEATURE = '' ######################################
MEMORY = 4 ######################################
...
WARMUP_EPOCHS = 2
NUM_WORKERS = 4
TRAIN_ROOT_DIR = f'/home/akashnyun/pandas_dataset/training_images_2048'
...
MODEL_SAVE_DIR = "checkpoint_deits_2048"
...
RUN_NAME_WANDB = "Baseline_PreTrained_PANDA_ImgSize2048_lr_1e-4_WD_DeitS"
FP16 = True