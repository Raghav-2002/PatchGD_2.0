...
from .protonet_patchgd import ProtoNet_Finetune_PatchGD
...
def get_model(args):
    ...
    elif args.deploy == 'finetune_pgd':
        model = ProtoNet_Finetune_PatchGD(backbone, args.ada_steps, args.ada_lr, args.aug_prob, args.aug_types)
